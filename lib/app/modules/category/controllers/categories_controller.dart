...
class CategoriesController extends GetxController {
  ...
  Future getCategories() async {
    try {
      ...
      // categories.add(categories[categories.length-1]);
      // categories[categories.length-1].name = "Travel App";
      // categories[categories.length-1].description = "";
      // categories[categories.length-1].image.url = "https://home-services.smartersvision.com/storage/app/public/369/car.svg";
