...
class CategoryListItemWidget extends StatelessWidget {
  ...
  final bool expanded;
  final bool travelAppWidget;

  CategoryListItemWidget({Key key, this.category, this.heroTag, this.expanded, this.travelAppWidget = false}) : super(key: key);
                ...
                children: <Widget>[
                  SizedBox(
                    ...
                    child: (category.image.url.toLowerCase().endsWith('.svg')
                        ? SvgPicture.network(
                            travelAppWidget ?
                            "https://home-services.smartersvision.com/storage/app/public/369/car.svg" :
                            category.image.url,
                  ...
                  Expanded(
                    child: Text(
                      travelAppWidget ? "Travel Service" :
                      category.name,
